...
Garde-fou ferme à la soumission (décision du 2026-08-10) : la plateforme REFUSE toute soumission qui dépasse 13 joueurs (acquis conservés + mise), dépasse le budget restant (points des acquisitions déduits, report des mises perdues et égalités inclus), ou dépasse un maximum de ligne (1 gardien, 6 défenseurs, 6 milieux, 4 attaquants, acquis compris). Les minima de ligne (3 défenseurs, 3 milieux, 1 attaquant) restent autorisés à la soumission : ils ne sont exigibles qu'en fin de phase.

Mise incomplète et brouillon (décision du 2026-08-12) : la soumission PARTICIPANT est refusée tant que l'effectif (acquis conservés + mise) ne compte pas exactement 13 joueurs. L'avancement de la mise est sauvegardé automatiquement en brouillon sur la plateforme : le participant peut quitter la page et revenir compléter sa mise avant l'heure butoir. Un brouillon n'est PAS une soumission : à la clôture du tour, seule une mise soumise est prise en compte au dépouillement. La saisie admin (rattrapage d'un participant hors plateforme) reste possible avec une mise incomplète : la pénalité de la règle 3.2.c s'applique alors au dépouillement. Miser moins que son budget restant reste autorisé (répartition libre, §5 : aucune pénalité).
...
| 2026-08-12 | Mise incomplète et brouillon : la soumission PARTICIPANT est refusée tant que acquis conservés + mise ≠ 13 joueurs. L'avancement du panier est auto-sauvegardé en brouillon serveur (AUCTION_BID status='draft') : il survit au rechargement, est remplacé à chaque modification, est consommé par la soumission finale et purgé au dépouillement. Un brouillon n'est ni visible de l'admin ni compté comme soumission ; non soumis à la clôture, il ne vaut aucune mise (bandeau explicite au participant). La saisie admin garde le droit d'enregistrer une mise incomplète (pénalité 3.2.c au dépouillement), comme elle ignore déjà la deadline. Miser sous le budget restant reste libre (§5). | Des participants soumettaient une mise incomplète en croyant « sauvegarder » leur avancement (ex. en attendant la création d'un joueur de légion étrangère) et prenaient la pénalité 3.2.c au dépouillement. Le brouillon donne un vrai support de sauvegarde, le refus ferme rend « Soumettre » sans ambiguïté (décision Julien). |

...
export default function TopicPage() {
  ...
  if (!topic) {
    return (
      <div className="text-center py-20">
        ...
        <Link href={"/forum"} className="text-sm text-gold hover:underline mt-2 block">
          Retour au forum
        </Link>
      </div>
    );
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <Link href={"/forum"} className="text-xs text-muted hover:text-gold transition-colors flex items-center gap-1 mb-3">

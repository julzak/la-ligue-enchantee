    ...
    if (showCumul) {
      ...
      return (
        ...
        >
          ...
          <PlayerAvatar imageUrl={player.imageUrl} name={player.playerName} size={28} clubLogoUrl={player.clubLogo} />
                          ...
                          {formerPlayers.map((c) => {
                            ...
                            return (
                              ...
                              >
                                ...
                                <PlayerAvatar imageUrl={c.imageUrl} name={c.playerName} size={28} clubLogoUrl={c.clubLogo} />
                                <div className="min-w-0">

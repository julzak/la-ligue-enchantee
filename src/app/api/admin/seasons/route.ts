...
export async function POST(req: Request) {
  ...
  try {
    ...
    return jsonError500("[seasons]", e, "Échec de la création de la saison");
  }
}
...
export async function PATCH(req: Request) {
  ...
  try {
    ...
    return jsonError500("[seasons]", e, "Échec de la mise à jour de la saison");
  }
}
...
export async function DELETE(req: Request) {
  ...
  try {
    ...
    return jsonError500("[seasons]", e, "Échec de la suppression de la saison");
  }
}
